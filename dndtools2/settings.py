"""
Django settings for dndtools2 project.
...
SECRET_KEY = '0))z_$fl87&jmc-e+)-*y0p^rviy0zr6p6uhy-k9%lvh(t-1as'
...
WSGI_APPLICATION = 'dndtools2.wsgi.application'
